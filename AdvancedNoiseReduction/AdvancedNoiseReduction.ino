...
// ═══════════════════════════════════════════════════════
const int SLAVE_ID = 1; // ⚠️ UPDATE THIS FOR EACH SLAVE!

// ═══════════════════════════════════════════════════════
// MASTER MAC ADDRESS (same for all slaves)
// ═══════════════════════════════════════════════════════
uint8_t masterAddress[] = {0x68, 0x09, 0x47, 0x60, 0x5D, 0x84};
...
const unsigned long DEBOUNCE_MS      = 2; // Pin must stay LOW this long to confirm real contact
...
void patternOne() {
  ...
  moveAll(10);     delay(500);
  moveAll(HALF);  delay(300);
  moveAll(10);     delay(1000);
}
